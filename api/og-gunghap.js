...
module.exports = (req, res) => {
  ...
  if (!d) {
    res.writeHead(302, { Location: 'https://whatsyoursaju.com' });
    res.end();
    return;
  }
  ...
  const ogUrl = `https://whatsyoursaju.com/share/gunghap?d=${encodeURIComponent(d)}`;
  const redirectUrl = `https://whatsyoursaju.com/?gunghap=${encodeURIComponent(d)}`;
...
<head>
  ...
  <meta property="og:image" content="https://whatsyoursaju.com/og-image.png">
  ...
  <meta name="twitter:image" content="https://whatsyoursaju.com/og-image.png">
