...
### A-3. 기술 준비
- [ ] index.html 광고 슬롯 빈 div 배치
- [ ] 가격표 → 이메일 대기 리스트 전환
- [ ] sitemap.xml 확장 (22+ URL)
- [ ] ads.txt 생성
- [ ] 공통 header/footer 네비게이션

### A-4. 비용 제어 (긴급)
- [ ] `/api/counsel.js`에 일일 3회 제한 (현재 무제한 → API 비용 폭발 위험)

### A-5. AdSense 신청
- [ ] 도메인 3~4주 경과 확인 후 신청
- [ ] ads.txt + AdSense 메타 태그 배치

### Phase A 완료 기준
- [ ] 18+ 콘텐츠 페이지 + 법적 3페이지 라이브
- [ ] Google Search Console 15+ 인덱싱
- [ ] AdSense 신청 완료
- [ ] AI 상담 일일 3회 제한 작동
...
- [ ] AI 상담 응답 공유 카드 (html2canvas)
- [ ] 궁합 URL 공유 OG 메타 최적화
- [ ] AI 상담 GA 이벤트 (ai_counsel, ai_limit_reached)
- [ ] 네이버 블로그 백링크 2~3개
